...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Admin can manage users, customers, laptops, services, and view reports
        ...
        // Create Staff/Technician role
        $staff = Role::firstOrCreate(
            ['name' => 'Staff'],
            [
                'description' => 'Staff/technician - can manage service tasks',
                'guard_name' => 'web',
            ]
        );

           // Staff permissions (service-related)
           ...
           $staff->syncPermissions($staffPermissions->pluck('id')->toArray());

           // Create Customer role
           $customerRole = Role::firstOrCreate(
               ['name' => 'Customer'],
               [
                   'description' => 'Customer - can view own service status',
                   'guard_name' => 'web',
               ]
           );
